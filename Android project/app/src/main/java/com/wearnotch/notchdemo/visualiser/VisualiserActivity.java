...
import com.unity3d.plugintest.BlankFragment;
import com.unity3d.plugintest.BlankFragment2;
...
import com.unity3d.plugintest.UnityPlayerActivity;
...
public class VisualiserActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public static Intent createUnityIntent(Context context, VisualiserData data, boolean realtime){
    ...
    void onTopViewClicked() {
        ...
        /*if (mUnityPlayerActivity == null) {
            mUnityPlayerActivity = new VisualiserActivity();
    ...
    void startFragment(){
        ...
        args.putString("message", RelativeNotchPosition);
    ...
    private void calculateAngles(int frameIndex) {
        ...
        //Log.i(LOGTAG, elbowAngles.toString());
