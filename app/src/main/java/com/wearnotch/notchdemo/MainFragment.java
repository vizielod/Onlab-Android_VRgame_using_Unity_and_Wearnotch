...
//import com.bme.plugintest.UnityPlayerActivity;

//import com.example.notchcommunicationlibrary.NotchPluginClass;
...
public class MainFragment extends BaseFragment {
    ...
    void getCalibData() {
        ...
        //Log.i(LOGTAG, NotchPluginClass.class.getName());

        Log.i(LOGTAG, "getCalibrationData");
        Log.i(LOGTAG, mNotchService.getCalibrationData(new EmptyCallback<Boolean>()).toString());
    }
